...
<head>
    ...
    <title>Gestionar Preguntas - Moderador</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <header class="dashboard-header">
                <h1>Gestionar Preguntas del Producto</h1>
            ...
            <div id="dynamic-content">
                ...
                if ($product) {
                    ...
                    echo "<h3>Preguntas del Producto</h3>";
                    echo "<div class='questions-list'>";
                    echo "<p>Aquí se mostrarán las preguntas relacionadas con este producto.</p>";
                    echo "<div class='actions'>";
                    echo "<button class='btn btn-primary'>Agregar Pregunta</button>";
                    echo "<button class='btn btn-secondary'>Ver Todas las Preguntas</button>";
                    echo "</div>";
                    echo "</div>";
