...
<head>
    ...
    <title>Editar Producto - Moderador</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <header class="dashboard-header">
                ...
                <a href="<?php echo url('auth/logout'); ?>" class="btn btn-danger">Cerrar sesión</a>
            </header>
            <div class="content">
                <h2>Editar Producto</h2>
                <form action="<?php echo url('moderator/edit-product/' . $product['id']); ?>" method="POST">
