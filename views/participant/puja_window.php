...
<head>
    ...
    <title>Puja - <?php echo htmlspecialchars($product['codigo'] ?? 'Proceso'); ?></title>
...
<body>
    <header class="main-header">
        ...
        <div class="user-info">
            ...
            <a href="<?php echo url('participant/view-product/' . ($product['id'] ?? '')); ?>" class="btn-return">Regresar</a>
        </div>
    </header>
    ...
    <main class="main-content puja-page">
        <h2 class="puja-title">Puja - <?php echo htmlspecialchars($product['codigo'] ?? ''); ?></h2>
        ...
        <?php
            ...
            $lastBidValue = $userLastBid['valor'] ?? 0;
        ...
        <?php else: ?>
            <div class="puja-section">
                <div class="puja-section-title">Proceso de Contratacion</div>
                <table class="puja-table">
                    <tr>
                        <td class="label">Entidad Contratante</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars($product['entidad'] ?? ''); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Objeto de Proceso de Contratacion</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars($product['objeto_proceso'] ?? ''); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Codigo</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars($product['codigo'] ?? ''); ?></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="puja-section">
                ...
                <table class="puja-table">
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <strong><?php echo htmlspecialchars((string)($product['variacion_minima'] ?? '0')); ?>%;</strong><br>
            ...
            <div class="puja-section">
                <div class="puja-section-title">Detalle del Proceso de Contratacion</div>
                <table class="puja-table">
                    <tr>
                        <td class="label">Tipo de Compra</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars($product['tipo_compra'] ?? ''); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Tipo de Contratacion</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars($product['tipo_contratacion'] ?? ''); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Forma de Pago</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars($product['forma_pago'] ?? ''); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Plazo de Entrega</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars((string)($product['plazo_entrega'] ?? '')); ?> dias</td>
                    </tr>
                    <tr>
                        <td class="label">Vigencia de Oferta</td>
                        <td class="value" colspan="2"><?php echo htmlspecialchars((string)($product['vigencia_oferta'] ?? '')); ?> dias</td>
                    </tr>
                </table>
            </div>
        <?php endif; ?>
    ...
    <script>
        (function() {
            ...
            const submitUrl = '<?php echo url('participant/submit-bid'); ?>';
            const statusUrl = '<?php echo url('participant/puja-status/' . ($product['id'] ?? 0)); ?>';
            const presupuesto = <?php echo isset($product['presupuesto_referencial']) ? (float)$product['presupuesto_referencial'] : 0; ?>;
            ...
            if (submitButton && offerInput) {
                submitButton.addEventListener('click', async () => {
                    ...
                    formData.append('producto_id', '<?php echo (int)($product['id'] ?? 0); ?>');
